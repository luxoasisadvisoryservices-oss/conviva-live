        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <motion.div {...fadeUp(0.4)} className="flex flex-wrap gap-3 mb-12">
              ...
              <a href="#how-it-works" className="inline-flex items-center gap-2 text-[#1E2D3D] border border-[#E5E5E0] hover:border-[#C0C0B8] font-medium px-6 py-3 rounded-lg transition-all duration-200 text-sm">
                See how it works
              </a>
            </motion.div>
