      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-sm text-[#3D5166] leading-relaxed max-w-xs">
              ...
              Precise, consistent, and human where it counts.
            </p>
          </div>

          {/* Navigation */}
          <div>
            <p className="text-xs font-medium text-[#7A8899] uppercase tracking-widest mb-4">
              Navigation
            </p>
            <ul className="space-y-2.5">
              {nav.map((item) => (
                <li key={item.label}>
                  <a
                    href={item.href}
                    className="text-sm text-[#3D5166] hover:text-teal-600 transition-colors"
                  >
                    {item.label}
                  </a>
                </li>
          ...
          <div>
            ...
            <div className="space-y-2.5">
              ...
              <a
                href="#contact"
                className="inline-flex items-center gap-2 mt-2 text-sm font-medium bg-teal-600 hover:bg-teal-800 text-white px-4 py-2 rounded-lg transition-all duration-200"
              >
                Book a demo
              </a>
            </div>
        ...
        <div className="border-t border-[#E5E5E0] pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-[#7A8899]">
            © {year} Conviva. All rights reserved.
          </p>

          {/* Legal entity — intentional and refined */}
          <div className="text-right">
            <p className="text-xs text-[#7A8899]">
              Conviva is a product of{" "}
              <span className="text-[#3D5166] font-medium">Lux Oasis Advisory &amp; Services LLC</span>
            </p>
            <p className="text-xs text-[#B0B0A8] mt-0.5">
              Lux Oasis Advisory &amp; Services LLC · All AI products &amp; services
            </p>
          </div>
        </div>
      </div>
